# STA-380-Assignment
This repository contains all the codes which were produced while doing the mini-project for the Predictive Modeling coursework (STA 380). Below are the questons we answered:
